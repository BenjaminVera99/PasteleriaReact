...
export default function Home() {
  return (
    ...
    <section id="portadaFoto" className="container my-4">
      <div className="imagen">
        <img src={portada} alt="Pastelería Mil Sabores" className="img-fluid" />
      </div>
      <h3>"50 años endulzando Chile con sabor y cariño"</h3>
    </section>

      <section id="TextoAbajo" className="container pb-5">
        <h2 className="text-center">¡Bienvenidos a Pastelería Mil Sabores!</h2>
        <p>
